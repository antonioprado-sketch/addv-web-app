...
| Eficiencia (herramientas externas, no skills nativas) | `caveman`, `graphify`, `claude-mem`, `superpowers`, `impeccable`, `find-skill`, `task-observer` — ver secciones siguientes |
