...
| Eficiencia (herramientas externas, no skills nativas) | `agent-skills` **(prioridad: instalar primero)**, `caveman`, `graphify`, `claude-mem`, `superpowers`, `find-skill`, `task-observer`, `ruflo`, `prompt-master` — ver secciones siguientes |
